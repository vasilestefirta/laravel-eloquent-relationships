...
This repo contains examples used within the [Eloquent Relationships](https://laracasts.com/series/eloquent-relationships) series from [laracasts.com](https://laracasts.com). All credits go to [Jeffrey Way](https://twitter.com/jeffrey_way), the author of those series and creator of Laracasts.
